...
public class Manager {
    ...
    public int findInArray(String username){
        for(int i=0;i<emptyHomeIndex;i++)
            if(usernameArray[j].equals(username))
                return i;
            return -1;
    }
    ...
    public void addTicket(String username,String password) throws SQLException {
        ...
        else if(ticketRepository.importTicket(ticket) != 0 )
    ...
    //::::>
    public void elTicket(String username,String password) throws SQLException {
            cinemaName = cinemaRepository.findCinema(username,password);
        ...
        else if(dateTicket.after(nowDate))
    ...
    //::::>
    public void howAllTicket() throws SQLException {
    ...
    public void searchFilm() throws SQLException {
        ...
        timeDate = input.nextLine();
        Date timeD = ate.valueOf(timeDate);
